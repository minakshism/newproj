sap.ui.define([
	...
	return UIComponent.extend("nv.ecAliasing.Component", {
		...
		init: function () {
			...
			this.getModel("editViewModel").setProperty("/editing", false);
			this.getModel("editViewModel").setProperty("/tobBtn", "sap-icon://edit");
