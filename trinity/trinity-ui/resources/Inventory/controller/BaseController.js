sap.ui.define([
	...
	"nv/Inventory/utils/inventoryPersonalized"
], function (Controller, MessageToast, Sorter, mlibrary, Filter, TablePersoController, inventoryPersonalized) {
	"use strict";
	var ResetAllMode = mlibrary.ResetAllMode;
	var partnerObj = {
		"idTransaction": "transaction_id",
		"idsession": "session_id",
		"idcreationdt": "create_datetime",
		"idProductno": "product_number",
		"idRpPrtnr": "reporting_partner_id"
	};
	return Controller.extend("nv.Inventory.controller.BaseController", {
		...
		initPersonalizedEC: function () {
			...
			this._PartnerPer = new sap.m.TablePersoController({
				...
				persoService: inventoryPersonalized
			}).activate();
		...
		onTablePersoRefresh: function (oEvent) {
			inventoryPersonalized.resetPersData().done(
				function () {
